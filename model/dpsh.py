...
class DPSH(object):
    ...
    def train(self, train_loader, train_labels, num_train):
        ...
        # train_labels = self.EncodingOnehot(train_labels, 10)
        ...
        for epoch in range(self.args.n_epochs):
            ...
            for iter, traindata in enumerate(train_loader, 0):
                ...
                # train_label_onehot = self.EncodingOnehot(train_label, 10)
                ...
                # u_ind = np.linspace(iter * self.batch_size,
                #                     np.min((num_train,
                #                             (iter + 1) * self.batch_size)) - 1,
                #                     batch_size_,
                #                     dtype=int)
                # for i, ind in enumerate(u_ind):
